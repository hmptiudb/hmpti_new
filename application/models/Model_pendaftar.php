...
// Start DATATABLE SERVER-SIDED
	...
	public function get_event_diikuti($email){
	    $query = "SELECT h_events.*, h_pendaftar.email FROM h_pendaftar INNER JOIN h_events ON h_pendaftar.id_event = h_events.id_event where h_pendaftar.email = '$email'";
