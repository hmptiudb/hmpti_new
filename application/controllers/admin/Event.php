...
class Event extends CI_Controller {
	...
	public function sertifikat_set_koordinat($id_event)
  {
	...
	public function download_sertifikat() {
	    $data['title'] = "Download sertifikat";
		$data['subtitle'] = "Download sertifikat";
		$data['daftar_event'] = $this->Model_pendaftar->get_event_diikuti($this->session->userdata('email'))->result_array();
		
		$this->load->view('member/templates/header', $data);
		$this->load->view('member/templates/sidebar', $data);
		$this->load->view('member/templates/navbar', $data);
		$this->load->view('member/daftar_sertif', $data);
		$this->load->view('member/templates/footer', $data);
		$this->load->view('member/daftar_sertif_js', $data);
	}
