<style>
  ...
  @keyframes shake {
    ...
    50% {
      transform: translate(18px, 1px) rotate(30deg);
    }
...
<div class="container marketing text-center d-flex justify-content-center mb-4">
  <div class="col-sm-12 col-md-8 col-lg-6">
    ...
    ?>
      <?php $event_hmpti = $event['pesan_utk_pendaftar'] ?>

      <?php $event_hmpti = explode("#", $event_hmpti) ?>
      
      <?php var_dump( $event_hmpti); ?> 
      ...
      <div class="row featurette text-center my-4">
        <div class="col-md-12" style="word-wrap: break-word;">
            <?php echo $event_hmpti['0'] ?>
            <?php echo $event_hmpti['1'] ?> KLIK DISINI
            <?php echo $event_hmpti['2'] ?>
          <!--<a href="<?php echo $event_hmpti['1'] ?>" > KLIK DISINI </a>-->
        </div>
      </div>
