<section id="ormawa">
  <div class="container" style="height: 100vh">
    <h1 class="headline-event text-center"><?php echo $this->title ?></h1>
      ...
      <div class="col-md-12">
        <div class="col-12 text-center d-flex justify-content-center mb-5">
          ...
          <form class="form-group col-sm-12 col-md-7" action="" method="POST" id="form_id_sertifikat">
            <label for="id_sertifikat">
              <h3 class="h3 pl-3 mb-3">Silakan Ketik ID Sertifikat Untuk Verifikasi</h3>
            </label>
