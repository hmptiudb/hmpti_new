    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	...
      	<div class="container">
            ...
            <!--      <input type="text" name="nim" class="form-control" id="edit_nim" placeholder="Nomor Induk Mahasiswa ...">-->
            <!--    </div>-->
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-primary" onclick="submit_form('#editForm')" id="edit_anggota">Simpan</button>
...
<div class="modal fade" id="modal-add" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	...
      	<div class="container">
              ...
              <form action="<?php echo base_url() ?>admin/anggota/add" method="post" role="form" id="addForm" novalidate="novalidate" enctype="multipart/form-data">
                ...
                <label>Image (opsional)</label>
                <div class="form-group">
                  <img width="240" height="240" src="<?= base_url('assets/img/no_image.jpg'); ?>" id="add_preview">
                  <p class="text-danger">Disarankan ukuran 500px x 500px</p>
                  <p>
                    <div class="custom-file">
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-primary" onclick="submit_form('#addForm')" id="tambah_anggota">Submit</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal">Batal</button>
      </div>
    </div>
    <!-- /.modal-content -->
